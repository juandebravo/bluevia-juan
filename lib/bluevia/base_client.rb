...
protected
    def RPC(url, method, request_params = nil)
      ...
      unless request_params.nil?
        #parsed_params = XSD::Mapping.obj2xml(request_params, 'params')
        parsed_params = request_params.to_xml(:skip_types => true)
        parsed_params = parsed_params.sub('<?xml version="1.0" encoding="UTF-8"?>', '')
        parsed_params = parsed_params.sub('<hash>', '')
        parsed_params = parsed_params.sub('</hash>', '')
      else
        parsed_params = ''
      end
      ...
      str_call = '<?xml version="1.0"?>
    <methodCall xmlns:sms="http://www.telefonica.com/schemas/UNICA/REST/sms/v1/" xmlns:dir="http://www.telefonica.com/schemas/UNICA/REST/directory/v1/" xmlns:mms="http://www.telefonica.com/schemas/UNICA/REST/mms/v1/" xmlns:com="http://www.telefonica.com/schemas/UNICA/REST/common/v1" xmlns="http://www.telefonica.com/schemas/UNICA/RPC/payment/v1">
    <version xmlns="http://www.telefonica.com/schemas/UNICA/RPC/definition/v1">v1</version>
    <method>' + method + '</method>' + parsed_params + '</methodCall>'
